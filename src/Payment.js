    ...
    return (
      <div id="PaymentForm">
        ...
        <div className="form-control">
          ...
          <Input name="name" type="text" required minLength="2" value={this.name} onChange={this.handleInputChange} onFocus={this.handleInputFocus} />
        </div>
        <div className="form-control">
          <label htmlFor="cardnumber">Card number</label>
          <InputMask name="number" mask="9999 9999 9999 9999" value={this.cardnumber} maskChar="" className="ant-input" onChange={this.handleInputChange} onFocus={this.handleInputFocus} required />
        </div>
        <div className="form-control">
          <label htmlFor="monthyear">Expiration date</label>
          <InputMask mask="99/99" maskChar="" name="expiry" className="ant-input" required value={this.monthYear} onChange={this.handleInputChange} onFocus={this.handleInputFocus} minLength="17"></InputMask>
        </div>
        <div className="form-control">
          <label htmlFor="monthyear">CVC</label>
          <InputMask mask="999" maskChar="" name="cvc" className="ant-input" required value={this.cvc} onChange={this.handleInputChange} onFocus={this.handleInputFocus} minLength="17"></InputMask>
        </div>
      </div>
    );
  }
